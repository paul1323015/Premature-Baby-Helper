const Icon = ({
  ...
  const icons = {
    sun: /*#__PURE__*/React.createElement("path", {
    ...
    droplet: /*#__PURE__*/React.createElement("path", {
      d: "M12 22a7 7 0 0 0 7-7c0-2-1-3.9-3-5.5s-3.5-4-4-6.5c-.5 2.5-2 4.9-4 6.5C6 15.1 5 17 5 15a7 7 0 0 0 7 7z"
    }),
    ...
    trendingUp: /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("polyline", {
    ...
    stethoscope: /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("path", {
      d: "M4.8 2.3A.3.3 0 0 0 4.5 2.6V8A6 6 0 0 0 16.5 8V2.6a.3.3 0 0 0-.3-.3h-1.4a.3.3 0 0 0-.3.3V8a4 4 0 0 1-8 0V2.6a.3.3 0 0 0-.3-.3z"
    }), /*#__PURE__*/React.createElement("path", {
      d: "M12 14v4a2 2 0 0 0 2 2h2a3 3 0 0 0 3-3V11"
    })),
    ...
    tag: /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("path", {
      d: "M12 2H2v10l11 11 10-10L12 2z"
    }), /*#__PURE__*/React.createElement("circle", {
      cx: "7",
      cy: "7",
      r: "1.5"
...
const WHO_GROWTH_DATA = {
  boy: {
    weight: [[-2, 1.2, 1.5, 2.0, 2.5, 3.0], [0, 2.5, 2.9, 3.3, 3.9, 4.4], [1, 3.4, 3.9, 4.5, 5.1, 5.8], [2, 4.3, 4.9, 5.6, 6.3, 7.1], [3, 5.0, 5.7, 6.4, 7.2, 8.0], [4, 5.6, 6.2, 7.0, 7.8, 8.7], [5, 6.0, 6.7, 7.5, 8.4, 9.3], [6, 6.4, 7.1, 7.9, 8.8, 9.8], [8, 6.9, 7.7, 8.6, 9.6, 10.7], [10, 7.4, 8.2, 9.2, 10.2, 11.4], [12, 7.8, 8.6, 9.6, 10.8, 12.0], [18, 8.8, 9.8, 10.9, 12.2, 13.7], [24, 9.7, 10.8, 12.2, 13.6, 15.3]],
    height: [[-2, 38, 40, 43, 46, 48], [0, 46.3, 48.0, 49.9, 51.8, 53.4], [1, 50.8, 52.8, 54.7, 56.7, 58.6], [2, 54.4, 56.4, 58.4, 60.4, 62.4], [3, 57.3, 59.3, 61.4, 63.5, 65.5], [4, 59.7, 61.8, 63.9, 66.0, 68.0], [5, 61.7, 63.8, 65.9, 68.0, 70.1], [6, 63.3, 65.5, 67.6, 69.8, 71.9], [8, 66.2, 68.4, 70.6, 72.8, 75.0], [10, 68.7, 71.0, 73.3, 75.6, 77.9], [12, 71.0, 73.4, 75.7, 78.1, 80.5], [18, 76.9, 79.6, 82.3, 85.0, 87.7], [24, 81.7, 84.6, 87.8, 90.9, 93.9]],
    head: [[-2, 27, 28.5, 30.5, 32.5, 34], [0, 31.9, 33.1, 34.5, 35.8, 37.0], [1, 34.9, 36.1, 37.3, 38.6, 39.7], [2, 36.9, 38.0, 39.1, 40.3, 41.3], [3, 38.3, 39.4, 40.5, 41.6, 42.6], [4, 39.4, 40.5, 41.6, 42.7, 43.7], [5, 40.3, 41.4, 42.5, 43.6, 44.6], [6, 41.0, 42.1, 43.3, 44.4, 45.4], [8, 42.2, 43.3, 44.5, 45.6, 46.6], [10, 43.1, 44.2, 45.4, 46.5, 47.6], [12, 43.8, 45.0, 46.1, 47.3, 48.3], [18, 45.3, 46.5, 47.7, 48.9, 50.0], [24, 46.3, 47.5, 48.7, 50.0, 51.1]]
  },
  girl: {
    weight: [[-2, 1.1, 1.4, 1.9, 2.4, 2.9], [0, 2.4, 2.8, 3.2, 3.7, 4.2], [1, 3.2, 3.6, 4.2, 4.8, 5.5], [2, 3.9, 4.5, 5.1, 5.8, 6.6], [3, 4.5, 5.2, 5.8, 6.6, 7.5], [4, 5.0, 5.7, 6.4, 7.3, 8.2], [5, 5.4, 6.1, 6.9, 7.8, 8.8], [6, 5.7, 6.5, 7.3, 8.2, 9.3], [8, 6.3, 7.0, 7.9, 9.0, 10.2], [10, 6.7, 7.5, 8.5, 9.6, 10.9], [12, 7.0, 7.9, 8.9, 10.1, 11.5], [18, 8.1, 9.1, 10.2, 11.5, 13.0], [24, 9.0, 10.2, 11.5, 13.0, 14.8]],
    height: [[-2, 37, 39, 42, 45, 47], [0, 45.4, 47.3, 49.1, 51.0, 52.7], [1, 49.8, 51.7, 53.7, 55.6, 57.6], [2, 53.0, 55.0, 57.1, 59.1, 61.1], [3, 55.6, 57.7, 59.8, 61.9, 64.0], [4, 57.8, 59.9, 62.1, 64.2, 66.4], [5, 59.6, 61.8, 64.0, 66.2, 68.5], [6, 61.2, 63.5, 65.7, 68.0, 70.3], [8, 64.0, 66.3, 68.7, 71.0, 73.4], [10, 66.4, 68.8, 71.2, 73.6, 76.1], [12, 68.5, 71.0, 73.5, 76.0, 78.5], [18, 74.9, 77.8, 80.7, 83.6, 86.5], [24, 80.0, 83.2, 86.4, 89.6, 92.9]],
    head: [[-2, 26.5, 28, 30, 32, 33.5], [0, 31.5, 32.7, 33.9, 35.1, 36.2], [1, 34.2, 35.4, 36.5, 37.7, 38.8], [2, 36.0, 37.1, 38.3, 39.4, 40.5], [3, 37.3, 38.4, 39.5, 40.6, 41.7], [4, 38.3, 39.4, 40.6, 41.7, 42.8], [5, 39.2, 40.3, 41.5, 42.6, 43.7], [6, 39.9, 41.0, 42.2, 43.3, 44.4], [8, 41.0, 42.2, 43.4, 44.5, 45.6], [10, 41.9, 43.1, 44.3, 45.4, 46.5], [12, 42.6, 43.8, 45.0, 46.2, 47.3], [18, 44.2, 45.4, 46.6, 47.8, 48.9], [24, 45.2, 46.4, 47.6, 48.9, 50.0]]
  }
};
...
const getAgesForDate = (measurementDateStr, birthDateStr, dueDateStr) => {
  ...
  const chronoAgeParts = birthDate && measurementDate && chronoDays >= 0 ? getCalendarAgeParts(birthDate, measurementDate) : {
    months: 0,
    days: 0
  };
  const correctedAgeParts = dueDate && measurementDate && correctedDays >= 0 ? getCalendarAgeParts(dueDate, measurementDate) : {
    months: 0,
    days: 0
  };
  let correctedText = '';
...
const PretermGrowthChart = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "p-3 bg-amber-50 border border-amber-200 rounded-xl text-xs text-amber-900 leading-relaxed flex flex-col gap-2 shadow-sm sm:flex-row sm:items-start"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "font-bold block text-amber-800"
    ...
    className: "relative bg-white rounded-2xl border p-3 shadow-inner overflow-hidden"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: `w-2 h-2 rounded-full ${showPercentiles ? 'bg-amber-500' : 'bg-slate-400'}`
  }), /*#__PURE__*/React.createElement("span", {
    className: "whitespace-nowrap"
  }, "百分位曲線：", showPercentiles ? '顯示' : '隱藏')), debugEnabled && /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      try {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "輸出 Debug")), /*#__PURE__*/React.createElement("button", {
    ...
    className: "whitespace-nowrap"
  }, "新增測量點")))), /*#__PURE__*/React.createElement("svg", {
    viewBox: `0 0 ${width} ${height}`,
    className: "w-full h-auto text-xs select-none"
  }, metricConfig.yTicks.map(yVal => /*#__PURE__*/React.createElement("g", {
    key: `y-${yVal}`
  }, /*#__PURE__*/React.createElement("line", {
    x1: padding.left,
    y1: yScale(yVal),
  ...
  }, yVal, " ", metricConfig.unit))), monthTicks.map(mVal => {
    ...
    y: padding.top - 6,
    textAnchor: "middle",
    className: "fill-amber-700 font-bold text-[10px]"
  }, "基準 0 個月"), /*#__PURE__*/React.createElement("text", {
    x: zeroX,
    y: height - padding.bottom + 33,
    textAnchor: "middle",
    className: "fill-amber-700 font-bold text-[9px]"
  }, useChronoAxis ? '（出生日）' : '（預產期）')), /*#__PURE__*/React.createElement("line", {
    x1: padding.left,
    y1: height - padding.bottom,
    x2: width - padding.right,
    y2: height - padding.bottom,
    ...
    return /*#__PURE__*/React.createElement("g", {
      ...
      d: pathD,
      fill: "none",
      stroke: percentileColors[i],
      strokeWidth: pIndex === 3 ? "2" : "1",
      strokeDasharray: pIndex === 3 ? "none" : "2,2"
    }), lastPt[0] <= maxX && /*#__PURE__*/React.createElement("text", {
      x: xScale(lastPt[0]) + 4,
      y: yScale(lastPt[pIndex]) + 3,
    ...
    return /*#__PURE__*/React.createElement("g", {
      ...
      y: labelY - 1,
      textAnchor: "middle",
      className: "fill-white font-extrabold text-[7.5px] font-mono"
    }, compactLabel));
  }), babyPoints.length > 1 && /*#__PURE__*/React.createElement("path", {
    d: babyPoints.map((p, i) => `${i === 0 ? 'M' : 'L'} ${p.x} ${p.y}`).join(' '),
    fill: "none",
    stroke: "#f59e0b",
    strokeWidth: "3",
    strokeLinecap: "round"
  }), babyPoints.map((p, i) => /*#__PURE__*/React.createElement("g", {
    key: `pt-${p.id || i}`,
    ...
    cy: p.y,
    r: "7",
    className: "fill-amber-500 stroke-white stroke-2 shadow-lg hover:r-9 transition-all"
  }), /*#__PURE__*/React.createElement("rect", {
    x: p.x - 26,
    y: p.y - 22,
    width: "52",
    height: "15",
    rx: "4",
    className: "fill-slate-900/80 shadow"
  }), /*#__PURE__*/React.createElement("text", {
    x: p.x,
    y: p.y - 11,
    textAnchor: "middle",
    className: "fill-amber-300 font-extrabold text-[10px]"
  }, p.value, " ", metricConfig.unit))), /*#__PURE__*/React.createElement("text", {
    x: width / 2,
    y: height - 8,
    textAnchor: "middle",
    className: "fill-amber-700 text-[11px] font-bold"
  }, useChronoAxis ? '實際出生月齡刻度' : '矯正月齡刻度（以預產期為 0 個月對齊 X 軸）')), babyPoints.length === 0 && /*#__PURE__*/React.createElement("div", {
    className: "p-3 text-center text-xs text-amber-800 bg-amber-50 border border-amber-200 rounded-xl my-2"
  }, "⚠️ 目前歷史列表中無【", metricConfig.label, "】數據點，點擊上方「新增測量點」登記", metricConfig.label, "。")), /*#__PURE__*/React.createElement("div", {
    className: "bg-white rounded-2xl border p-3 shadow-sm space-y-2"
  }, /*#__PURE__*/React.createElement("h4", {
    className: "font-bold text-xs text-slate-700 flex justify-between items-center"
  }, /*#__PURE__*/React.createElement("span", null, "歷史測量列表"), /*#__PURE__*/React.createElement("span", {
    className: "text-[11px] text-slate-400 font-normal"
  }, "共 ", growthHistory.length, " 筆紀錄")), growthHistory.length === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "p-3 text-center text-xs text-slate-400 border rounded-xl bg-slate-50"
  }, "尚無紀錄，點擊上方「新增測量點」登記身高、體重與頭圍。") : /*#__PURE__*/React.createElement("div", {
    className: "space-y-1.5 max-h-52 overflow-y-auto pr-1 text-xs"
    ...
    return /*#__PURE__*/React.createElement("div", {
      key: rec.id,
      className: "p-2 border rounded-xl flex items-center justify-between bg-slate-50/70 hover:bg-amber-50/50 transition-colors"
    ...
    })), "資料異常")), /*#__PURE__*/React.createElement("div", {
  ...
  }, "新增生長數據紀錄"), /*#__PURE__*/React.createElement("button", {
  ...
  }, "測量日期"), /*#__PURE__*/React.createElement("input", {
    type: "date",
    required: true,
    min: "2020-01-01",
    max: "2030-12-31",
    ...
    className: "font-bold block mb-1"
  }, "體重(kg)"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    step: "0.01",
    placeholder: "3.2",
    value: recWeight,
    ...
    className: "font-bold block mb-1"
  }, "身長(cm)"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    step: "0.1",
    placeholder: "48",
    value: recHeight,
    ...
    className: "font-bold block mb-1"
  }, "頭圍(cm)"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    step: "0.1",
    placeholder: "34",
    value: recHead,
    onChange: e => setRecHead(e.target.value),
    className: "w-full p-2 border rounded-xl"
  }))), /*#__PURE__*/React.createElement("div", {
...
function App() {
      ...
      try {
        ...
        try {
          ...
          if (pb && pd && pb.getTime() > pd.getTime()) {
            ...
            const corrected = {
              ...parsed,
              birthDate: parsed.dueDate,
              dueDate: parsed.birthDate
            };
            try {
  ...
  const defaultMilestones = [{
    ...
    id: 2,
    text: '眼神能跟隨視線移動或關注黑白卡 10 秒 (矯正 1-2 個月)',
    done: false
  }, {
    id: 3,
    text: '聽到大人溫柔說話會停止哭泣或發出咕嚕聲 (矯正 2 個月)',
    done: false
  }, {
    id: 4,
  ...
  const APP_STORAGE_KEYS = ['sun_baby_profile_v5', 'sun_baby_growth_history_v1', 'sun_baby_logs_v1', 'sun_baby_doctor_notes_v1', 'sun_baby_notes_v1', 'sun_baby_milestones_v1', 'sun_baby_emergency_snapshot_v1', AUTO_BACKUP_STORAGE_KEY, ADVANCED_RESTORE_SETTING_KEY, CHAT_HISTORY_STORAGE_KEY];
  ...
  const calculateStorageUsage = () => {
    ...
    return {
      bytes,
      percent: percent > 0 && percent < 0.01 ? '< 0.01' : percent.toFixed(2)
    };
  };
  ...
  const clearRecentAutoBackups = () => {
    const confirmed = window.confirm('⚠️ 此操作將清除所有進階還原紀錄。清除後將無法再從最近 3 筆自動備份中還原。確定要繼續嗎？');
    if (!confirmed) return;
  ...
  const handleRestoreRecentAutoBackup = entry => {
    ...
    const confirmed = window.confirm(`即將載入最近自動備份（建立時間：${timeText}）。\n\n此動作將覆蓋目前所有資料，請確認是否繼續？`);
    if (!confirmed) {
  ...
  const handleImportBackupObj = backupData => {
    ...
    const importedNotebookNotes = Array.isArray(backupData.notes) ? backupData.notes : Array.isArray(backupData.notebook) ? backupData.notebook : Array.isArray(backupData.notebookNotes) ? backupData.notebookNotes : [];
  ...
  const handleAddGrowthRecord = newRec => {
    ...
    if (typeof cleanedRec.weight !== 'undefined') setBabyInfo(prev => ({
      ...prev,
      currentWeight: cleanedRec.weight
    }));
    if (typeof cleanedRec.height !== 'undefined') setBabyInfo(prev => ({
      ...prev,
      currentHeight: cleanedRec.height
    }));
    if (typeof cleanedRec.head !== 'undefined') setBabyInfo(prev => ({
      ...prev,
      currentHead: cleanedRec.head
    }));
    showToast('📈 已新增測量數據點！');
  };
  ...
  const handleSaveMilestone = () => {
    ...
    if (editingMilestoneId === null) {
      ...
      setMilestones(milestones.map(item => item.id === editingMilestoneId ? {
        ...item,
        text
      } : item));
      showToast('✅ 已更新發展里程碑');
  ...
  const handleResetData = () => {
    const confirmed = window.confirm("警告：此操作將清除所有資料！資料刪除後無法復原。建議先使用畫面上方的『備份/還原』功能匯出備份檔案。確定要繼續清空所有資料嗎？");
    if (!confirmed) return;
    clearAppStorageData();
    setBabyInfo({
      name: '',
  ...
  const handleClearLogs = () => {
    const confirmed = window.confirm('⚠️ 此操作將清除所有照護日誌（餵奶、尿布等紀錄）。確定要繼續嗎？');
    if (!confirmed) return;
    setLogs([]);
    showToast('🗑️ 已清除照護日誌');
  };
  ...
  const handleClearMilestones = () => {
    const confirmed = window.confirm('⚠️ 此操作將清除所有發展里程碑。確定要繼續嗎？');
    if (!confirmed) return;
    setMilestones([]);
    ...
    requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        ...
        fontsReady.then(() => new Promise(resolve => {
          ...
          divElements.sort(() => Math.random() - 0.5).slice(0, Math.min(4, divElements.length)).forEach((divElement, index) => {
  ...
  const latestWeightDisplay = React.useMemo(() => {
    const latestEntry = [...growthHistory].sort((a, b) => new Date(b.date || 0) - new Date(a.date || 0))
  ...
  const defaultChatMessages = [{
    sender: 'bot',
    text: '你好！我是巴掌小太陽的 AI 照護助手 ☀️。您可以詢問關於【矯正月齡生長曲線】計算、每日奶量評估、資料同步備份與還原、筆記本使用等問題喔！'
  }];
  ...
  const handleAddDoctorNote = e => {
    ...
    if (editingDoctorNoteId !== null) {
      ...
      } : note).sort((a, b) => `${b.date || ''} ${b.time || ''}`.localeCompare(`${a.date || ''} ${a.time || ''}`)));
      showToast('💾 已儲存看診備忘修改！');
    } else {
      if (!ensureStorageCapacityForNewData()) return;
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "p-2 bg-yellow-400 text-amber-900 rounded-full shadow-md shrink-0"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "sun",
    ...
    className: "max-w-4xl mx-auto px-3 pt-4 pb-20 sm:px-4 md:px-6 lg:px-8 xl:px-10",
    style: {
      paddingBottom: 'calc(5rem + env(safe-area-inset-bottom))'
    }
  }, /*#__PURE__*/React.createElement("div", {
    className: `p-4 rounded-2xl border shadow-sm mb-4 md:p-5 ${cardBg}`
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between md:gap-4"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-3 min-w-0"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-12 h-12 rounded-full bg-amber-200 border-2 border-amber-400 flex items-center justify-center text-2xl shadow-inner shrink-0"
  }, "👶"), /*#__PURE__*/React.createElement("div", {
    className: "min-w-0"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex flex-wrap items-center gap-2"
  ...
  }, babyInfo.name ? `${babyInfo.name} 寶寶` : '小太陽寶寶'), /*#__PURE__*/React.createElement("span", {
    className: "text-xs px-2 py-0.5 rounded-full bg-amber-100 text-amber-800 font-bold"
  }, babyInfo.gender === 'girl' ? '👧 女寶' : '👦 男寶'), /*#__PURE__*/React.createElement("button", {
    ...
    name: "edit",
    className: "w-3 h-3"
  }), /*#__PURE__*/React.createElement("span", null, "自訂/修改"))), /*#__PURE__*/React.createElement("div", {
    className: "text-xs font-bold text-amber-600 mt-0.5 flex items-center gap-1"
  }, /*#__PURE__*/React.createElement("span", null, "⚡️ ", ageData.correctedText)), /*#__PURE__*/React.createElement("div", {
    className: "text-[11px] text-slate-400"
  }, ageData.chronoText, " ", babyInfo.gestationalWeeks ? `(${babyInfo.gestationalWeeks}週出生)` : ''))), /*#__PURE__*/React.createElement("div", {
    className: "text-left sm:text-right"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-[11px] text-slate-400"
  }, "當前體重"), /*#__PURE__*/React.createElement("div", {
    className: "text-xl font-black text-amber-600"
  }, latestWeightDisplay ? `${latestWeightDisplay} kg` : '— kg')))), /*#__PURE__*/React.createElement("div", {
    ...
    className: `px-3 py-2 rounded-xl text-[11px] sm:text-xs font-bold whitespace-nowrap transition-all ${activeTab === tab.id ? 'bg-amber-500 text-white shadow-md' : 'bg-white border text-slate-600 hover:bg-amber-50'}`
    ...
    className: "text-[11px] text-slate-400 mt-2 text-right"
  }, targetMilkNum > 0 ? `已達成每日目標的 ${milkPercent}%` : '未設定每日目標奶量 (可點擊「自訂/修改」設定)')), /*#__PURE__*/React.createElement("div", {
  ...
  }, "🍼 記餵奶"), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
  ...
  }), "矯正月齡生長曲線圖表"), /*#__PURE__*/React.createElement("div", {
    className: "flex flex-wrap items-center gap-2"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex rounded-xl bg-slate-100 p-1 text-xs"
  }, [{
    id: 'weight',
    label: '體重'
  }, {
    ...
    name: "plus",
    className: "w-3.5 h-3.5"
  }), "新增紀錄")), logs.length === 0 ? /*#__PURE__*/React.createElement("div", {
  ...
  }, "清除諮詢紀錄")))), /*#__PURE__*/React.createElement("div", {
    id: "pdf-report-content",
    style: {
      visibility: 'visible',
      clipPath: 'inset(100%)'
    },
    className: "box-border w-[718px] p-8 bg-white text-slate-800 space-y-6 font-sans"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "匯出時間：", formatLocalDateTime())), /*#__PURE__*/React.createElement("div", {
  ...
  }, "尚無測量紀錄") : /*#__PURE__*/React.createElement("table", {
    ...
    className: "p-2 border-b"
  }, "體重 (kg)"), /*#__PURE__*/React.createElement("th", {
    className: "p-2 border-b"
  }, "身長 (cm)"), /*#__PURE__*/React.createElement("th", {
    className: "p-2 border-b"
  }, "頭圍 (cm)"))), /*#__PURE__*/React.createElement("tbody", null, growthHistory.map(rec => /*#__PURE__*/React.createElement("tr", {
    key: rec.id,
    className: "border-b"
  }, /*#__PURE__*/React.createElement("td", {
    className: "p-2"
  }, rec.date), /*#__PURE__*/React.createElement("td", {
    className: "p-2"
  }, rec.weight || '—'), /*#__PURE__*/React.createElement("td", {
    className: "p-2"
    ...
    className: "text-xs text-slate-400"
  }, "無門診提問紀錄") : /*#__PURE__*/React.createElement("ul", {
    className: "space-y-1.5 text-xs"
  }, doctorNotes.map(n => /*#__PURE__*/React.createElement("li", {
    key: n.id,
    className: "pdf-item p-2 bg-slate-50 border rounded-lg"
    ...
    className: "text-xs text-slate-400"
  }, "無筆記紀錄") : /*#__PURE__*/React.createElement("div", {
    className: "space-y-2 text-xs"
  }, notes.map(n => /*#__PURE__*/React.createElement("div", {
    key: n.id,
    className: "pdf-item p-2.5 bg-slate-50 border rounded-lg space-y-1"
  }, /*#__PURE__*/React.createElement("div", {
    className: "font-bold text-amber-800"
  }, "【", n.category, "】", n.title, " ", /*#__PURE__*/React.createElement("span", {
    ...
    className: "font-bold block mb-1"
  }, "寶寶姓名"), /*#__PURE__*/React.createElement("input", {
    type: "text",
    placeholder: "例如：小太陽",
    ...
    className: "font-bold block mb-1"
  }, "生理性別"), /*#__PURE__*/React.createElement("select", {
    ...
    value: "boy"
  }, "👦 男寶"), /*#__PURE__*/React.createElement("option", {
    value: "girl"
  }, "👧 女寶"))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "font-bold block mb-1"
  }, "出生週數(週)"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    placeholder: "例如：30",
    value: editFormData.gestationalWeeks,
    onChange: e => setEditFormData({
      ...editFormData,
      gestationalWeeks: e.target.value
    }),
    className: "w-full p-2 border rounded-xl"
  }))), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-1 gap-2 sm:grid-cols-2"
    ...
    className: "font-bold block mb-1"
  }, "實際出生日期"), /*#__PURE__*/React.createElement("input", {
    type: "date",
    ...
    className: "font-bold block mb-1"
  }, "預產期 (算矯正月齡)"), /*#__PURE__*/React.createElement("input", {
    type: "date",
    ...
    className: "font-bold block mb-1"
  }, "出生體重(kg)"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    step: "0.01",
    placeholder: "2.8",
    ...
    className: "font-bold block mb-1"
  }, "最新體重(kg)"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    step: "0.01",
    placeholder: "3.2",
    ...
    onChange: e => setEditFormData({
      ...editFormData,
      targetDailyMilk: e.target.value
    }),
    className: "w-full p-2 border rounded-xl"
  })), /*#__PURE__*/React.createElement("div", {
    className: "flex gap-2 pt-2"
    ...
    type: "submit",
    className: "flex-1 py-2 text-xs bg-amber-500 hover:bg-amber-600 text-white font-bold rounded-xl shadow-md"
  }, "儲存設定"))))), showAddLogModal && /*#__PURE__*/React.createElement("div", {
    className: "fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4 z-50"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-full max-w-sm p-5 rounded-2xl border shadow-xl bg-white space-y-3"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "🍼 餵奶"), /*#__PURE__*/React.createElement("button", {
    type: "button",
    ...
    className: "p-1.5 bg-amber-100 text-amber-800 rounded-lg"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "book",
    className: "w-5 h-5"
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "font-bold text-base text-amber-800 flex items-center gap-2"
  }, "筆記本", /*#__PURE__*/React.createElement("span", {
    className: "text-[11px] font-normal px-2 py-0.5 bg-amber-100 text-amber-800 rounded-full"
  }, "已存 ", notes.length, " / 1000 條")), /*#__PURE__*/React.createElement("p", {
    className: "text-[11px] text-slate-400"
  }, "家長快速紀錄門診問題、大事記與備忘"))), /*#__PURE__*/React.createElement("button", {
    ...
    className: `p-3 rounded-xl border space-y-2.5 transition-colors ${editingNoteId !== null ? 'bg-amber-100/60 border-amber-400 shadow-md ring-2 ring-amber-300' : 'bg-amber-50/70 border-amber-200'}`
  }, editingNoteId !== null && /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between text-xs text-amber-900 font-bold bg-amber-200 px-2.5 py-1 rounded-lg"
  }, /*#__PURE__*/React.createElement("span", {
    className: "flex items-center gap-1"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "edit",
    className: "w-3.5 h-3.5"
  }), "正於編輯模式修改中..."), /*#__PURE__*/React.createElement("button", {
    type: "button",
    onClick: handleCancelEditNote,
    className: "text-amber-800 hover:text-red-600 underline text-[11px]"
  }, "放棄修改")), /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col gap-2 sm:flex-row"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-full sm:w-1/3"
  }, /*#__PURE__*/React.createElement("label", {
    className: "block text-[11px] font-bold text-slate-600 mb-1"
  }, "標籤分類"), /*#__PURE__*/React.createElement("select", {
    value: noteCategory,
    onChange: e => setNoteCategory(e.target.value),
    className: "w-full p-2 text-xs border rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-amber-400"
  }, /*#__PURE__*/React.createElement("option", {
    value: "回診提問"
  }, "【回診提問】"), /*#__PURE__*/React.createElement("option", {
    value: "成長大事記"
  }, "【成長大事記】"), /*#__PURE__*/React.createElement("option", {
    value: "其他備忘"
  }, "【其他備忘】"))), /*#__PURE__*/React.createElement("div", {
    className: "w-full sm:w-2/3"
  }, /*#__PURE__*/React.createElement("label", {
    className: "block text-[11px] font-bold text-slate-600 mb-1 flex justify-between"
  }, /*#__PURE__*/React.createElement("span", null, "標題 (最多 30 字)"), /*#__PURE__*/React.createElement("span", {
    className: "text-[10px] text-slate-400"
  }, noteTitle.length, "/30")), /*#__PURE__*/React.createElement("input", {
    type: "text",
    maxLength: 30,
    ...
    className: "block text-[11px] font-bold text-slate-600 mb-1 flex justify-between"
  }, /*#__PURE__*/React.createElement("span", null, "筆記內容 (純文字，最多 1000 字)"), /*#__PURE__*/React.createElement("span", {
    className: `text-[10px] ${noteContent.length >= 1000 ? 'text-red-500 font-bold' : 'text-slate-400'}`
  }, noteContent.length, "/1000")), /*#__PURE__*/React.createElement("textarea", {
    rows: 3,
    maxLength: 1000,
  ...
  }, editingNoteId !== null ? '💾 儲存修改' : '➕ 新增筆記'), editingNoteId !== null && /*#__PURE__*/React.createElement("button", {
    type: "button",
    onClick: handleCancelEditNote,
  ...
  }, ['全部', '回診提問', '成長大事記', '其他備忘'].map(cat => /*#__PURE__*/React.createElement("button", {
    key: cat,
    ...
    className: "p-4 text-center text-xs text-slate-400 border rounded-xl bg-slate-50"
  }, "目前沒有", filterNoteCategory === '全部' ? '' : `【${filterNoteCategory}】`, "相關筆記") : filteredNotes.map(note => /*#__PURE__*/React.createElement("div", {
    key: note.id,
    className: "p-3 border rounded-xl bg-white shadow-sm space-y-1.5 hover:border-amber-300 transition-colors"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between"
  }, /*#__PURE__*/React.createElement("span", {
    className: "px-2 py-0.5 bg-amber-100 text-amber-800 rounded font-bold text-[10px]"
  }, note.category), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-[10px] text-slate-400"
  }, note.createdAt), /*#__PURE__*/React.createElement("button", {
    ...
    className: "font-bold text-sm text-amber-700 flex items-center gap-1.5"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "hardDrive",
    className: "w-4 h-4"
    ...
    className: "w-10 h-10 rounded-xl bg-red-100 text-red-600 flex items-center justify-center text-lg shrink-0"
  }, "⚠️"), /*#__PURE__*/React.createElement("div", {
    className: "min-w-0"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "font-bold text-sm text-red-700"
  }, storageRecoveryMeta.title), /*#__PURE__*/React.createElement("p", {
    className: "text-[11px] leading-relaxed text-slate-600 mt-1"
  }, storageRecoveryMeta.message))), /*#__PURE__*/React.createElement("div", {
    className: "space-y-2"
  }, /*#__PURE__*/React.createElement("button", {
  ...
  }, "清理"), /*#__PURE__*/React.createElement("button", {
  ...
  }, "📤 匯出備份"), /*#__PURE__*/React.createElement("p", {
    className: "text-[11px] leading-relaxed"
  }, "更換裝置或備份資料時使用，可以匯出完整的紀錄檔。"), /*#__PURE__*/React.createElement("div", {
  ...
  }), "選擇備份檔案", /*#__PURE__*/React.createElement("input", {
    type: "file",
    accept: ".json",
    ...
    name: "trash",
    className: "w-4 h-4"
  }), "資料管理與清除"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setShowDataMgmtModal(false),
    className: "text-slate-400 hover:text-slate-600"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "x",
    className: "w-4 h-4"
    ...
    className: "space-y-2 bg-slate-50 p-3 rounded-xl border border-slate-200 text-slate-700"
  }, /*#__PURE__*/React.createElement("p", {
    className: "font-bold text-xs"
  }, "🧹 個別清除功能"), /*#__PURE__*/React.createElement("p", {
    className: "text-[11px] leading-relaxed"
    ...
    name: "trash",
    className: "w-4 h-4"
  }), "清除照護日誌"), /*#__PURE__*/React.createElement("button", {
    ...
    name: "trash",
    className: "w-4 h-4"
  }), "清除生長數據"), /*#__PURE__*/React.createElement("button", {
    onClick: handleClearMilestones,
    className: "w-full py-3 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl font-bold flex items-center justify-center gap-2 transition-colors"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "trash",
    className: "w-4 h-4"
  }), "清除發展里程碑"), /*#__PURE__*/React.createElement("button", {
    onClick: handleClearChatHistory,
    className: "w-full py-3 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl font-bold flex items-center justify-center gap-2 transition-colors"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "trash",
    className: "w-4 h-4"
  }), "清除 AI 諮詢紀錄"), /*#__PURE__*/React.createElement("button", {
    onClick: handleResetMilkSettings,
    className: "w-full py-3 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl font-bold flex items-center justify-center gap-2 transition-colors"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "trash",
    className: "w-4 h-4"
  }), "重置奶量設定/目標")), /*#__PURE__*/React.createElement("div", {
    className: "rounded-xl border border-amber-200 bg-amber-50/80 p-2.5 text-amber-900"
  }, /*#__PURE__*/React.createElement("p", {
    className: "font-bold text-[11px] mb-1"
  }, "⚠️ 還原與清除前請注意"), /*#__PURE__*/React.createElement("p", {
    className: "text-[10.5px] leading-relaxed"
  }, "如果要把資料還原到另一台手機或裝置，先做好備份最安心。至於任何清除操作，這些都是不可逆的動作，請務必先確認是否已備份再執行。")), /*#__PURE__*/React.createElement("div", {
    ...
    name: "trash",
    className: "w-3.5 h-3.5"
  }), "清除所有本地資料(重設應用程式預設值)"))))), showMilestoneModal && /*#__PURE__*/React.createElement("div", {
    className: "fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50"
  }, /*#__PURE__*/React.createElement("div", {
    className: `w-full max-w-md p-5 rounded-2xl border shadow-xl ${cardBg}`
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex justify-between items-center pb-3 border-b mb-4"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "font-bold text-base text-emerald-800"
  }, editingMilestoneId === null ? '新增發展里程碑' : '編輯發展里程碑'), /*#__PURE__*/React.createElement("button", {
  ...
  }, "里程碑內容"), /*#__PURE__*/React.createElement("textarea", {
    value: milestoneText,
  ...
  }, "儲存")))), showHelpModal && /*#__PURE__*/React.createElement("div", {
    className: "fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50"
  }, /*#__PURE__*/React.createElement("div", {
    className: `w-full max-w-xl p-5 rounded-2xl border shadow-xl max-h-[90vh] flex flex-col ${cardBg}`
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex justify-between items-center pb-3 border-b mb-3"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "font-bold text-base text-amber-800 flex items-center gap-2"
  }, "📖 「巴掌小太陽」說明與特色"), /*#__PURE__*/React.createElement("button", {
    ...
    className: "flex-1 overflow-y-auto space-y-4 pr-1 no-scrollbar text-xs"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "🍼 日常照護與生長紀錄"), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-600 leading-relaxed"
  }, "輕鬆記錄每日餵奶量、尿布情況與體重，掌握寶寶每一天的微小進步。")), /*#__PURE__*/React.createElement("div", {
  ...
  }, "🌱 發展里程碑清單"), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-600 leading-relaxed"
  }, "精選關鍵成長指標，幫助爸媽安心追蹤寶寶的發展。")), /*#__PURE__*/React.createElement("div", {
    className: "p-3 bg-blue-50/70 border border-blue-200 rounded-xl space-y-1"
  }, /*#__PURE__*/React.createElement("div", {
    className: "font-bold text-blue-900 text-sm flex items-center gap-1.5"
  }, "⚙️ 彈性雙月齡切換"), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-600 leading-relaxed"
  }, "支援對齊【預產期】之矯正月齡與【實際出生日】之實際月齡，並可自由切換生長曲線圖表對照。")), /*#__PURE__*/React.createElement("div", {
  ...
  }, "📝 隨手筆記本"), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-600 leading-relaxed"
  }, "快速記錄門診提問、成長大事記與照護備忘，支援分類篩選與編輯，讓照護資訊不遺漏。")), /*#__PURE__*/React.createElement("div", {
    ...
    className: "font-bold text-rose-900 text-sm flex items-center gap-1.5"
  }, "🤖 暖心照護叮嚀與 AI 諮詢"), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-600 leading-relaxed"
  }, "內建實用的照護小叮嚀與 AI 諮詢助手，隨時陪伴爸媽走過每個焦慮時刻。"))), /*#__PURE__*/React.createElement("div", {
  ...
  }, "🌸 溫馨陪伴理念"), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-700 leading-relaxed"
  }, "這款工具不帶任何商業盈利目的或複雜條款，只希望能像它的名字一樣，靜靜地陪伴、溫暖每一個需要的家庭。"), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-700 leading-relaxed"
  }, "如果你身邊剛好有早產兒新手爸媽，或是你自己正經歷這段守護的旅程，歡迎直接點擊連結取用。願每一位像小太陽一樣勇敢的孩子，都能在大家的守護下，平安健康地長大！ ❤️")), /*#__PURE__*/React.createElement("div", {
    className: "p-4 bg-amber-50 border border-amber-300 rounded-xl space-y-2.5 text-amber-950 shadow-sm"
  }, /*#__PURE__*/React.createElement("div", {
    className: "font-bold text-amber-900 text-sm flex items-center gap-1.5 border-b border-amber-200 pb-2"
  }, "☀️ 給早產兒爸媽的一封信"), /*#__PURE__*/React.createElement("p", {
    className: "leading-relaxed"
  }, "各位辛苦的爸爸媽媽們好，我是亮愷。"), /*#__PURE__*/React.createElement("p", {
    className: "leading-relaxed"
  }, "我是一名在 30 週、僅 1450 公克時出生的早產兒（也就是大家常說的「巴掌仙子」）。一路走來，我深深明白早產兒家庭在育兒起步時，常要面對許多焦慮、手忙腳亂，以及繁瑣的成長紀錄。"), /*#__PURE__*/React.createElement("p", {
    className: "leading-relaxed"
  }, "因此，我利用空閒時間，運用工程師的背景，從無到有打造了一款完全免費、無商業氣息的網頁工具——「巴掌小太陽」，希望能給予這群辛苦的爸媽們一些最實質的陪伴與幫助。"), /*#__PURE__*/React.createElement("p", {
    className: "leading-relaxed font-semibold pt-1 border-t border-amber-200/60 text-amber-900"
  }, "本應用程式由早產兒亮愷為公益個人開發，免費提供予所有早產兒家庭使用。")), /*#__PURE__*/React.createElement("div", {
  ...
  }, "🔒 隱私權與資料安全保護聲明"), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-600 leading-relaxed"
  }, "巴掌小太陽承諾：我們無比重視您與寶寶的隱私。本應用程式（網頁）採用瀏覽器本地快取技術（Local Storage）。您所輸入的寶寶姓名、生日、預產期，以及每一筆體重、身高、頭圍等日常照護紀錄，全部都只會儲存在您自己的手機或電腦瀏覽器中。"), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-600 leading-relaxed"
  }, "我們的網頁伺服器絕對不會收集、傳輸、或留存任何您填寫的隱私資料。整個操作過程完全在您的終端設備獨立執行，網路上沒有任何人能窺探您寶寶的成長數據。"), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-600 leading-relaxed"
  }, "『巴掌小太陽』純粹為公益與照護輔助而生。沒有會員登入、沒有廣告追蹤，更沒有資料外洩的風險。您可以百分之百放心地將這裡當作專屬您與寶寶的安心育兒避風港。尊重隱私，請安心使用。")), /*#__PURE__*/React.createElement("div", {
    className: "text-center text-[11px] text-slate-400 font-medium pt-1"
  }, "開發日期：2026/7/27")), /*#__PURE__*/React.createElement("div", {
    className: "pt-3 border-t mt-3 flex justify-end"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setShowHelpModal(false),
